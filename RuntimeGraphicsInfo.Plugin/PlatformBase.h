// Copied from sample https://github.com/Unity-Technologies/NativeRenderingPlugin/blob/master/PluginSource/source/PlatformBase.h
#pragma once
...
// UNITY_WEBGL - WebGL
#if defined(_MSC_VER) or defined(WIN32)
    #define UNITY_WIN 1
